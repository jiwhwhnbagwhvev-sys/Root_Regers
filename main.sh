...
26 WiFi Intruder Scanner                25 HP Security Guard
27 Auto Spam Block Guard
0 Exit.          
${R}"
}
...
while true; do
    ...
    case "$p" in
        ...
        25) bash modules/hp_security_guard.sh ;;
        26) bash modules/wifi_intruder_scan.sh ;;
        27) bash modules/auto_spam_block_guard.sh ;;
        0)  echo "[✓] Keluar..."; exit ;;
